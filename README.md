...
- Genera un repositorio privado ```TC1028.py.ej-activ12.<GitHub-Profile>``` en esta organización a partir de este repositorio plantilla, dando clic en el botón ```Use this template```.
...
```
cd /workspaces/TC1028.py.ej-activ12.<GitHub-Profile>
```
